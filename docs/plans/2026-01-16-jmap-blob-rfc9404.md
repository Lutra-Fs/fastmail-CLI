...
> **IMPORTANT:** Fastmail does not currently support the JMAP Blob Management Extension (RFC 9404). This implementation exists for compatibility with other JMAP providers, but `fastmail blob` commands will not work with Fastmail accounts.
